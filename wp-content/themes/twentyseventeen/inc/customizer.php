...
function twentyseventeen_customize_register($wp_customize) {
     ...
     * Demo Customize
     */
    $wp_customize->add_section('demo_customize', array(
        'title' => __('Demo Customize', 'twentyseventeen'),
        'priority' => 125, // Before Additional CSS.
    ));
    $wp_customize->add_setting('option3', array(
        'default' => '200',
        'transport' => 'postMessage',
    ));
    $wp_customize->add_control(new WP_Customize_Range($wp_customize, 'option3', array(
        'label' => 'Price Min',
        'section' => 'demo_customize',
        'type' => 'range',
        'input_attrs' => array('min' => 0, 'max' => 1000, 'step' => 1),
        'option' => 'option3',
    )));
    
    $wp_customize->add_setting('option4', array(
        'default' => '800',
        'transport' => 'postMessage',
    ));
    $wp_customize->add_control(new WP_Customize_Range($wp_customize, 'option4', array(
        'label' => 'Price Max',
        'section' => 'demo_customize',
        'type' => 'range',
        'input_attrs' => array('min' => 0, 'max' => 1000, 'step' => 1),
