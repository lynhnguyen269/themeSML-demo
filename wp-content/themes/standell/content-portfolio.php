    ...
    <div class="container">
        <?php if ($portfolio_single_style == 'full_content') { ?>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <h4 class="title-project"><?php echo esc_html__('Project Information', 'standell') ?></h4>
                    <ul class="infomation-project">
                        <li><span><?php esc_html_e('Category :', 'standell'); ?></span>
                        ...
                        <li><span><?php echo esc_html__('Client :', 'standell') ?></span><?php $portfolio_client = get_post_meta(get_the_ID(), 'portfolio_client', true); ?>
                            <?php echo esc_attr($portfolio_client); ?></li>
                        <li><span><?php echo esc_html__('Date :', 'standell') ?></span>
                            <?php echo get_the_date(); ?></a>
                        </li>
                        <li><span><?php esc_html_e('Tags :', 'standell'); ?></span>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <ul class="infomation-project <?php echo esc_attr($portfolio_single_style); ?>">
                        <li class="portfolio-client"><div><?php echo esc_html__('Client :', 'standell') ?></div><?php $portfolio_client = get_post_meta(get_the_ID(), 'portfolio_client', true); ?>
                            <?php echo esc_attr($portfolio_client); ?></li>
                        <li class="portfolio-tags"><div><?php esc_html_e('Tags :', 'standell'); ?></div>
                            <?php echo esc_attr(the_terms(get_the_ID(), 'portfolios_tag', '', ', ', ''));
                            ?>
                        </li>
                        <li class="portfolio-category"><div><?php esc_html_e('Category :', 'standell'); ?></div>
                            <?php echo esc_attr(the_terms(get_the_ID(), 'portfolios_category', '', ', ', ''));
                            ?>
                        </li>
                        <li class="portfolio-url"><div><?php echo esc_html__('Project Url :', 'standell') ?></div>
                            <?php $portfolio_url = get_post_meta(get_the_ID(), 'portfolio_url', true); ?>
                            <?php echo esc_attr($portfolio_url); ?>
                        </li>
                        <li class="portfolio-date"><div><?php echo esc_html__('Date :', 'standell') ?></div>
