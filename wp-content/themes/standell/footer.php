...
<?php if (themesflat_choose_opt('enable_slide_client') == 1): ?> 
    <div class="flat-client" style="background-color: <?php echo esc_attr($client_bg_color); ?>">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="slide-client" data-auto="<?php
                    if (themesflat_choose_opt('autoplay') == 1) {
                        echo 'true';
                    } else {
                        echo 'false';
                    }
                    ?>" data-item="<?php echo esc_attr($show_logo); ?>"
                         data-nav="<?php
                         if (themesflat_choose_opt('show_nav') == 1) {
                             echo 'true';
                         } else {
                             echo 'false';
                         }
                         ?>"
                         data-dots="<?php
                         if (themesflat_choose_opt('show_dot') == 1) {
                             echo 'true';
                         } else {
                             echo 'false';
                         }
    ...
    <?php if (themesflat_get_opt('show_footer') == 1): ?> 
        <footer class="footer <?php (themesflat_meta('footer_class') != "" ? esc_attr(themesflat_meta('footer_class')) : ''); ?>">      
            <div class="container">
                ...
                $columns = themesflat_widget_layout_left(themesflat_choose_opt('footer_widget_areas', $themesflat_mainID));
                $copyright = themesflat_widget_layout_copyright(themesflat_choose_opt('footer_widget_areas', $themesflat_mainID));
                $key = 0;
                ...
                if (themesflat_choose_opt('footer_widget_areas') == 5) {
                    ...
                    <div class="row footer-widgets justify-content-between">
                        <div class="flat-widget-footer col-12 col-sm-6 col-md-4">
                            <?php
                ...
                <?php } else {
                    ?>
                    <div class="row footer-widgets justify-content-between">
                        <div class="flat-widget-footer col-12 col-sm-6 col-md-<?php themesflat_esc_attr($copyright); ?>">
                            <?php
                            $logo_site = themesflat_choose_opt('site_logo');
                            $logo_retina_site = themesflat_choose_opt('site_retina_logo');
                            if ($logo_site) :
                        ...
                        foreach ($columns as $key => $column) {
                            ?>
                            <div class="flat-widget-footer col-12 col-sm-6 col-md-<?php themesflat_esc_attr($column); ?>">
                                <?php
                                $key = $key + 1;
            ...
            <div class="row">
                <div class="col-md-12">                        
                    ...
                    <div class="social-footer">
                        <?php
                        if (themesflat_choose_opt('enable_social_link_footer') == 1):
