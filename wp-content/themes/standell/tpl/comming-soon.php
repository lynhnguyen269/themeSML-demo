                ...
                <div class="page-content">					
                    <div id="countdown" class="countdown clearfix" data-set_time="<?php echo esc_attr(themesflat_choose_opt('comming_soon_time')); ?>">
                        <div class="square">
                            ...
                            <div class="text"><?php esc_html__('DAY', 'standell'); ?></div>
                        </div>
                        <div class="square">
                            <div class="numb time-hours">24</div>
                            <div class="text"><?php esc_html__('HOUR', 'standell'); ?></div>
                        </div>
                        <div class="timer">:</div>
                        <div class="square">
                            <div class="numb time-mins">35</div>
                            <div class="text"><?php esc_html__('MINUTE', 'standell'); ?></div>
                        </div>
                        <div class="timer">:</div>
                        <div class="square">
                            <div class="numb time-secs">09</div>
                            <div class="text"><?php esc_html__('SECOND', 'standell'); ?></div>
                        </div>
                    </div>
                    <div class="comming-text">
                        <h3> <?php echo esc_html__('We\'re getting ready to launch', 'standell') ?> </h3>
                        <h6> <?php echo esc_html__('We\'ll be here soon with our new awesome site, subscribe to be notified.', 'standell') ?></h6>
                    </div>
                </div><!-- .page-content -->
