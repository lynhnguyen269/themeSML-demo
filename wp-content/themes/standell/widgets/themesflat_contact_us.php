...
class Themesflat_Contact_Us_widget extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
                'widget_themesflat_contact_us', esc_html__('Themesflat - Contact Us', 'standell'), array(
            'classname' => 'widget-themesflat-contact-us',
            'description' => esc_html__('Contact Us', 'standell')
                )
        );
    }
    ...
    function widget($args, $instance) {
        ...
        if (!empty($text)) {
            echo do_shortcode('<div class="contact-us-content">' . $text . '</div>');
        }
        echo '</div>';
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('text')); ?>"><?php esc_html_e('Content:', 'standell'); ?></label>
