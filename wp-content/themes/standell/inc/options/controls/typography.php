...
if (class_exists('WP_Customize_Control')) {
    ...
    class themesflat_Typography extends WP_Customize_Control {
        ...
        public function render_content() {
            $this->titles = array(
                '100' => esc_html__('Thin 100', 'standell'),
                '100italic' => esc_html__('Thin 100 italic', 'standell'),
                '200' => esc_html__('Extra-light 200', 'standell'),
                '200italic' => esc_html__('Extra-light 200 italic', 'standell'),
                '300' => esc_html__('Light 300', 'standell'),
                '300italic' => esc_html__('Light 300 italic', 'standell'),
                '400' => esc_html__('Normal 400', 'standell'),
                '400italic' => esc_html__('Normal 400 italic', 'standell'),
                'regular' => esc_html__('Normal 400', 'standell'),
                'italic' => esc_html__('Normal 400 italic', 'standell'),
                '500' => esc_html__('Medium 500', 'standell'),
                '500italic' => esc_html__('Medium 500 italic', 'standell'),
                '600' => esc_html__('Semi-bold 600', 'standell'),
                '600italic' => esc_html__('Semi-bold 600 italic', 'standell'),
                '700' => esc_html__('Bold 700', 'standell'),
                '700italic' => esc_html__('Bold 700 italic', 'standell'),
                '800' => esc_html__('Extra-bold 800', 'standell'),
                '800italic' => esc_html__('Extra-bold 800 italic', 'standell'),
                '900' => esc_html__('Ultra-bold 900', 'standell'),
                '900itallic' => esc_html__('Ultra-bold 900 italic', 'standell')
            );

            $this->titles_subsets = array(
                "cyrillic-ext" => esc_html__("Cyrillic Extended", 'standell'),
                "greek" => esc_html__("Greek", 'standell'),
                "greek-ext" => esc_html__("Greek Extended", 'standell'),
                "latin-ext" => esc_html__("Latin Extended", 'standell'),
                "cyrillic" => esc_html__("Cyrillic", 'standell'),
                "vietnamese" => esc_html__("Vietnamese", 'standell'),
                "latin" => esc_html__("Latin", 'standell')
            );
            ...
            <div class="themesflat-options-control-inputs">
                <?php if (in_array('family', $this->fields)): ?>
                    <div class="themesflat-options-control-chosen typography-font">
                        <div class="themesflat-options-control-title">
                            <label for="<?php themesflat_esc_attr($name) ?>-family"><?php esc_html_e('Font Family', 'standell') ?></label>
                        </div>
                        <div class="themesflat-options-control-inputs">
                            <select name="<?php themesflat_esc_attr($name) ?>[family]" id="<?php themesflat_esc_attr($name) ?>-family" class="select-choosen" >
                                <optgroup label="<?php themesflat_esc_attr('Google Fonts', 'standell') ?>">
                ...
                <?php if (in_array('size', $this->fields)): ?>
                    <div class="typography-size">
                        <div class="themesflat-options-control-title">
                            <label for="<?php themesflat_esc_attr($name) ?>-size"><?php esc_html_e('Font Size (px)', 'standell') ?></label>
                        </div>
                        <div class="themesflat-options-control-inputs">
                ...
                <?php if (in_array('line_height', $this->fields)): ?>
                    <div class="typography-line_height">
                        <div class="themesflat-options-control-title">
                            <label for="<?php themesflat_esc_attr($name) ?>-line_height"><?php esc_html_e('Line_height (px)', 'standell') ?></label>
                        </div>
                        <div class="themesflat-options-control-inputs">
                ...
                <div class="themesflat-options-control-chosen typography-style">
                    <div class="themesflat-options-control-title">
                        <label><?php esc_html_e('Font Weight & Style', 'standell') ?></label>
                    </div>
                    <div class="themesflat-options-control-inputs">
                        <label>
                ...
                <?php if (in_array('subsets', $this->fields)): ?>
                    <div class="themesflat-options-control typography-subsets themesflat-options-control-switcher active">
                        <div class="themesflat-options-control-title">
                            <label><?php esc_html_e('Font subsets', 'standell') ?></label>
                        </div>
                        <div class="themesflat-options-control-inputs">
                            <?php foreach ($fonts[$index]->subsets as $id => $subset): ?>
                                ...
                                <label class="_options-switcher-subsets">
                                    ...
                                    ?> value="<?php themesflat_esc_attr($subset); ?>" name="<?php themesflat_esc_attr($name); ?>[subsets]">
                ...
                <?php if (in_array('color', $this->fields)): ?>
                    <div class="themesflat-options-control-color-picker typography-color">
                        <div class="themesflat-options-control-title">
                            <label><?php esc_html_e('Font Color', 'standell') ?></label>
                        </div>
                        <div class="themesflat-options-control-inputs">
