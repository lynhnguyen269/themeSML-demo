...
function themesflat_shortcode_default_id() {
    return array(
        ...
        'group' => esc_html__('Design Options', 'standell'),
...
function themesflat_iconpicker_type_eleganticons($icons) {
    $tmp_icon = themesflat_add_icons('icon', THEMESFLAT_LINK . 'assets/css/font-elegant.css');
...
function themesflat_iconpicker_type_icomoon($icons) {
    $tmp_icon = themesflat_add_icons('icon', THEMESFLAT_LINK . 'assets/css/icomoon.css');
    foreach ($tmp_icon as $icon) {
...
function themesflat_iconpicker_type_ionicons($icons) {
    $tmp_icon = themesflat_add_icons('icon', THEMESFLAT_LINK . 'assets/css/font-ionicons.css');
    foreach ($tmp_icon as $icon) {
...
function themesflat_iconpicker_type_themifyicons($icons) {
    $tmp_icon = themesflat_add_icons('ti', THEMESFLAT_LINK . 'assets/css/themify-icons.css');
    foreach ($tmp_icon as $icon) {
...
function themesflat_map_icons($name = 'icon', $heading_name = 'Icon') {
    return array(
        array(
            'type' => 'dropdown',
            'heading' => $heading_name . esc_html__(' library', 'standell'),
            'value' => array(
                esc_html__('None', 'standell') => 'none',
                esc_html__('Font Awesome', 'standell') => 'fontawesome',
                esc_html__('Open Iconic', 'standell') => 'openiconic',
                esc_html__('Typicons', 'standell') => 'typicons',
                esc_html__('Entypo', 'standell') => 'entypo',
                esc_html__('Linecons', 'standell') => 'linecons',
                esc_html__('Mono Social', 'standell') => 'monosocial',
                esc_html__('Material', 'standell') => 'material',
                esc_html__('Font Ionicons', 'standell') => 'ionicons',
                esc_html__('Font Elegant', 'standell') => 'eleganticons',
                esc_html__('Font Themify Icons', 'standell') => 'themifyicons',
                esc_html__('Font Icomoon Icons', 'standell') => 'icomoon',
            ),
            'std' => 'none',
            'admin_label' => true,
            'param_name' => $name . '_type',
            'description' => esc_html__('Select icon library.', 'standell'),
        ...
        array(
            ...
            'description' => esc_html__('Select icon from library.', 'standell'),
            'integrated_shortcode_field' => $name . '_'
        ),
        array(
            'type' => 'iconpicker',
        ...
        array(
            'type' => 'iconpicker',
            'heading' => esc_html__('Icon', 'standell'),
...
function themesflat_predefined_header_styles() {
    ...
    if (empty($styles)) {
        $styles = apply_filters('themesflat/header_styles', array(
            'header-v1' => esc_html__('Classic', 'standell'),
            'header-v2' => esc_html__('Header style 02', 'standell'),
            'header-v4' => esc_html__('Modern', 'standell'),
        ));
    }
...
function themesflat_available_social_icons() {
    $icons = apply_filters('themesflat_available_icons', array(
        'twitter' => array('iclass' => 'fab fa-twitter', 'title' => 'Twitter', 'share_link' => 'https://twitter.com/intent/tweet?url='),
        'facebook' => array('iclass' => 'fab fa-facebook', 'title' => 'Facebook', 'share_link' => 'https://www.facebook.com/sharer.php?u='),
        'google-plus' => array('iclass' => 'fab fa-google-plus', 'title' => 'Google Plus', 'share_link' => 'https://plus.google.com/share?url='),
        'pinterest' => array('iclass' => 'fab fa-pinterest', 'title' => 'Pinterest', 'share_link' => 'https://pinterest.com/pin/create/bookmarklet/?url='),
        'instagram' => array('iclass' => 'fab fa-instagram', 'title' => 'Instagram', 'share_link' => ''),
        'youtube' => array('iclass' => 'fab fa-youtube', 'title' => 'Youtube', 'share_link' => ''),
        'linkedin' => array('iclass' => 'fab fa-linkedin', 'title' => 'LinkedIn', 'share_link' => 'https://www.linkedin.com/shareArticle?url='),
        'vimeo' => array('iclass' => 'fab fa-vimeo-square', 'title' => 'Vimeo', 'share_link' => ''),
        'behance' => array('iclass' => 'fab fa-behance', 'title' => 'Behance', 'share_link' => ''),
        'bitcoin' => array('iclass' => 'fab fa-bitcoin', 'title' => 'Bitcoin', 'share_link' => ''),
        'bitbucket' => array('iclass' => 'fab fa-bitbucket', 'title' => 'BitBucket', 'share_link' => ''),
        'codepen' => array('iclass' => 'fab fa-codepen', 'title' => 'Codepen', 'share_link' => ''),
        'delicious' => array('iclass' => 'fab fa-delicious', 'title' => 'Delicious', 'share_link' => 'https://delicious.com/save?url='),
        'deviantart' => array('iclass' => 'fab fa-deviantart', 'title' => 'DeviantArt', 'share_link' => ''),
        'digg' => array('iclass' => 'fab fa-digg', 'title' => 'Digg', 'share_link' => 'http://digg.com/submit?url='),
        'dribbble' => array('iclass' => 'fab fa-dribbble', 'title' => 'Dribbble', 'share_link' => ''),
        'flickr' => array('iclass' => 'fab fa-flickr', 'title' => 'Flickr', 'share_link' => ''),
        'foursquare' => array('iclass' => 'fab fa-foursquare', 'title' => 'Foursquare', 'share_link' => ''),
        'github' => array('iclass' => 'fab fa-github-alt', 'title' => 'Github', 'share_link' => ''),
        'jsfiddle' => array('iclass' => 'fab fa-jsfiddle', 'title' => 'JSFiddle', 'share_link' => ''),
        'reddit' => array('iclass' => 'fab fa-reddit', 'title' => 'Reddit', 'share_link' => 'https://reddit.com/submit?url='),
        'skype' => array('iclass' => 'fab fa-skype', 'title' => 'Skype', 'share_link' => 'https://web.skype.com/share?url='),
        'slack' => array('iclass' => 'fab fa-slack', 'title' => 'Slack', 'share_link' => ''),
        'soundcloud' => array('iclass' => 'fab fa-soundcloud', 'title' => 'SoundCloud', 'share_link' => ''),
        'spotify' => array('iclass' => 'fab fa-spotify', 'title' => 'Spotify', 'share_link' => ''),
        'stack-exchange' => array('iclass' => 'fab fa-stack-exchange', 'title' => 'Stack Exchange', 'share_link' => ''),
        'stack-overflow' => array('iclass' => 'fab fa-stack-overflow', 'title' => 'Stach Overflow', 'share_link' => ''),
        'steam' => array('iclass' => 'fab fa-steam', 'title' => 'Steam', 'share_link' => ''),
        'stumbleupon' => array('iclass' => 'fab fa-stumbleupon', 'title' => 'Stumbleupon', 'share_link' => 'http://www.stumbleupon.com/submit?url='),
        'tumblr' => array('iclass' => 'fab fa-tumblr', 'title' => 'Tumblr', 'share_link' => 'https://www.tumblr.com/widgets/share/tool?canonicalUrl='),
        'rss' => array('iclass' => 'fas fa-rss', 'title' => 'RSS', 'share_link' => '')
    ));
...
function themesflat_menu_fallback() {
    ...
    <li>
    <a class="menu-fallback" href="' . esc_url(admin_url('nav-menus.php')) . '">' . esc_html__('Create a Menu', 'standell') . '</a></li></ul>';
}
...
if (!function_exists('themesflat_favicon')) {
    ...
    function themesflat_favicon() {
        if (!( function_exists('has_site_icon') && has_site_icon() )) {
            ...
            printf('<link rel="shortcut icon" href="' . esc_url(THEMESFLAT_LINK . 'assets/icon/favicon.png') . '" />');
        }
    }
...
if (version_compare($GLOBALS['wp_version'], '4.1', '<')) :
    ...
    function themesflat_wp_title($title, $sep) {
        ...
        if (( $paged >= 2 || $page >= 2 ) && !is_404()) {
            $title .= " $sep " . sprintf(esc_html__('Page %s', 'standell'), max($paged, $page));
        }
...
function themesflat_dynamic_sidebar($sidebar) {
    if (is_active_sidebar($sidebar)) {
        ...
        if (is_user_logged_in()) {
            printf(__('This is the %s widget area.Please go to <a href="%s">Admin</a>.', 'standell'), esc_attr($sidebar), esc_url(admin_url('widgets.php')));
        }
    }
}
        ...
        foreach ($value as $key => $val) {
            if ($key != '__ordering__') {
                ...
                printf(
                    ...
                    </li>', esc_attr($key), esc_url($val), esc_html($title), esc_attr($fa), esc_attr($key)
                );
            }
        }
        ?>
