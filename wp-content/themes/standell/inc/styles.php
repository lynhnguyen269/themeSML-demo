...
function themesflat_custom_styles($custom) {
    ...
    // Header Background
    $header_banner = themesflat_choose_opt('header-banner');
    $caption_banner = themesflat_choose_opt('header-banner-caption');
    if ($header_banner != '') {
        $custom .= ".themesflat_header_wrap { background: url('" . $header_banner . "') center /cover no-repeat}'" . "\n";
    } elseif ($caption_banner == '') {
        $custom .= ".themesflat_header_wrap { min-height: 850px}'" . "\n";
    } else {
        $custom .= ".themesflat_header_wrap { background-color:" . esc_attr($mainnav_backgroundcolor) . ";}" . "\n";
    }
    ...
    if ($hover_body_color != '') {
        $custom .= ".iconbox .box-header .box-icon span, .themesflat-portfolio .item .category-post a, .color_theme, .themesflat-button.blog-list-small, .comment-list-wrap .comment-reply-link,.portfolio-single .content-portfolio-detail h3,.portfolio-single .content-portfolio-detail ul li:before, .testimonial-sliders.style3 .author-name a,.themesflat_iconbox .iconbox-icon .icon span.top_bar2 .wrap-header-content ul li i, .themesflat-portfolio .grid .item .featured-post a::before, .themesflat-portfolio .grid-no-padding .item .featured-post a::before, .testimonial-sliders.style1 .testimonial-author .author-name, .testimonial-sliders.style2 .testimonial-author .author-name, .testimonial-sliders.style1 .testimonial-author .author-name a, .testimonial-sliders.style2 .testimonial-author .author-name a, .themesflat_imagebox.style7 .themesflat-button.circle-outlined i, .themesflat-portfolio .grid4 .category-post-1 a:hover:before, .themesflat_button_container .themesflat-button.no-background:hover, .blog-shortcode.blog-grid article .entry-meta.meta-below .post-date a:hover, .blog-shortcode.blog-grid-image-left article .entry-meta.meta-below .post-date a:hover, .themesflat-related .title, .themesflat_imagebox.style1 .themesflat-button,  .portfolio-container.grid .item .portfolio-details-content .date a:hover, .themesflat-portfolio .list-small .item .title-post a, .themesflat-portfolio .list-small .item .portfolio-details-content .themesflat-button, .themesflat-services-shortcodes .services-details-content .services-title a, .themesflat-services-shortcodes .services-details-content .date a:hover, .themesflat-team .team-name, .themesflat-team .themesflat-button, .themesflat-team.grid-style2 .themesflat-button:hover, .themesflat-team.grid-style2 .social-links a, .themesflat_counter.style3 .counter-icon .icon, .themesflat_counter.style3 .counter-content-bottom .counter-link, .themesflat_counter.style3 .counter-content-bottom .counter-content, .flat-language .current .unstyled li:hover a, .themesflat_price .price-header .title, .themesflat_imagebox .imagebox-title a, .comment-reply-title, .comment-title, .widget .widget-title, .testimonial-sliders.sidebar .author-name a, article .entry-title a, article .entry-title, article .content-post .themesflat-button, .widget.widget-themesflat-contact-us .widget-title, .wrap-header-content > ul > li > .text strong, .testimonial-sliders .sub-title1, .testimonial-sliders .sub-title2, .testimonial-sliders .sub-title3, .blog-shortcode-title, .title_related_portfolio, .themesflat_iconbox .iconbox-content .themesflat-button, .themesflat-team .team-name a, .themesflat_iconbox.style5 .number-text, .wpb-js-composer .vc_tta-color-grey.vc_tta-style-classic .vc_tta-tab > a span, .wpb-js-composer .vc_tta-color-grey.vc_tta-style-classic.style2 .vc_tta-tab.vc_active > a span, .navigation.posts-navigation .nav-links li a .meta-nav:hover, .woocommerce .content-product .themesflat-wrap-product .product .star-rating, .woocommerce .products .product .star-rating, .blog-single .entry-footer .themesflat-socials li a, .woocommerce .social-share-article .themesflat-socials li a, .blog-shortcode.blog-grid-style2 article .entry-content .entry-meta .themesflat-button-container .themesflat-button:hover, .blog-grid article .content-post .post-categories a:hover, .blog-list-small article .content-post .post-categories a:hover { color:" . esc_attr($hover_body_color) . ";}" . "\n";
