...
if ( ! function_exists( 'themesflat_shortcode_register_assets' ) ) {
	...
	function themesflat_shortcode_register_assets() {		
		...
		wp_register_script( 'themesflat-google', 'https://maps.googleapis.com/maps/api/js?key='.get_theme_mod('key_google_map_api', 'AIzaSyAIEU6OT3xqCksCetQeNLIPps6-AYrhq-s&region=GB').'&v=3.7', array(), '1.0', true );
