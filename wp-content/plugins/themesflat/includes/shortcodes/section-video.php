...
function themesflat_section_video_shortcode_params() {
	vc_map( array(
		...
		'name'        => esc_html__( 'Themesflat: Section Video', 'redbiz' ),
		...
		'params'      => array(
			...
			array(
				...
				'description'    => esc_html__( '( Enter your image size Ex: full,... Default: 370x225 ). Alternatively enter size in pixels (Example: 200x100 (Width x Height)).', 'redbiz' ),
			...
			array(
				'type' => 'textfield',
				'heading' => esc_html__( 'Video Link', 'redbiz' ),
				'param_name' => 'link',
				'description' => esc_html__( 'Enter custom url for video', 'redbiz' ),				
				'std'		 => 'https://www.youtube.com/embed/LHO9BdVDJVM?autoplay=1'
				),

			array(
				'type'        => 'textfield',
				'heading'     => esc_html__( 'Icon Play', 'redbiz' ),
			...
			array(
				'type' => 'textfield',
				'heading' => esc_html__( 'Size play', 'redbiz' ),
				'description' => esc_html__( 'Icon play size in px. Ex:90px,... Default: 70px', 'redbiz' ),
			...
			array(
				'type' => 'textfield',
				'heading' => esc_html__( 'Font size icon play', 'redbiz' ),
				'description' => esc_html__( 'Font size icon play in px. Ex:30px,... Default: 22px', 'redbiz' ),
			...
			array(
				...
				'description'    => esc_html__( '( Enter your class Ex: left,center,right,color-white ).', 'redbiz' ),
				'param_name' => 'class'
			),			
