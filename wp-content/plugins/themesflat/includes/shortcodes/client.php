...
function themesflat_client_shortcode_params() {
	 ...
	 */
	vc_map( array(
		'name'                    => esc_html__( 'Themesflat: Client Slider', 'redbiz' ),
		...
		'params'                  => array(			
			...
			array(
				'type' => 'checkbox',
				'heading' => esc_html__( 'Hide Pagination Control', 'redbiz' ),
				'param_name' => 'hide_control',
				'description' => esc_html__( 'If YES pagination control will be removed.', 'redbiz' ),
				'value' => array( esc_html__( 'Yes, please', 'redbiz' ) => 'yes' )
			),

			array(
				'type' => 'checkbox',
				'heading' => esc_html__( 'Hide prev/next buttons', 'redbiz' ),
				'param_name' => 'hide_buttons',
				'description' => esc_html__( 'If "YES" prev/next control will be removed.', 'redbiz' ),
				'value' => array( esc_html__( 'Yes, Please', 'redbiz' ) => 'yes' )
			),
	...
	vc_map( array(
		...
		'name'        => esc_html__( 'Themesflat: Client', 'redbiz' ),
		'icon'        => THEMESFLAT_ICON,
		'category'    => esc_html__( 'redbiz', 'redbiz' ),
		'params'      => array(	
			array(
			...
			array(
				'type' => 'colorpicker',
				'heading'    => esc_html__( 'Image Overlay Color', 'redbiz' ),
			...
			array(
				'type'       => 'attach_image',
				'heading'    => esc_html__( 'Image Transparent', 'redbiz' ),
