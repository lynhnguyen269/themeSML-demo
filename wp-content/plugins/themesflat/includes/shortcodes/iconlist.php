...
function themesflat_iconlist_shortcode_params() {
	 ...
	 */
	vc_map( array(
		'name'                    => esc_html__( 'Themesflat: Icon List', 'redbiz' ),
		...
		'params'                  => array(
			array(
				'type' => 'checkbox',
				'heading' => esc_html__( 'Use Auto Increment Number', 'redbiz' ),
				'param_name' => 'auto_increment_icon',
				'description' => esc_html__( 'This option will disable font icon and use auto increment number ', 'redbiz' ),
				'value' => array(
	...
	vc_map( array(
		...
		'name'        => esc_html__( 'Themesflat: Icon List Item', 'redbiz' ),
		'icon'        => THEMESFLAT_ICON,
		'category'    => esc_html__( 'redbiz', 'redbiz' ),
		...
		'params'      => array_merge($icons_params,array(
			...
			array(
				'type' => 'checkbox',
				'heading' => esc_html__( 'Enable Icon Circle Style', 'redbiz' ),
			...
			array(
				'type' => 'attach_image',
				'heading' => esc_html__( 'List Image', 'redbiz' ),
				'param_name' => 'image',
				'description' => esc_html__( 'Default image for all items in the list', 'redbiz' )
				),
			...
			array(
				'type' => 'textfield',
				'heading' => esc_html__( 'Link to', 'redbiz' ),
				'param_name' => 'link',
				),
